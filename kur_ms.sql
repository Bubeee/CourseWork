...
ALTER TABLE [enum_view]
	ADD CONSTRAINT [UQ_enum_view_view] UNIQUE ([view])
;
...
ALTER TABLE [enum_view] ADD CONSTRAINT [PK_enum_view] 
	PRIMARY KEY CLUSTERED ([id])
;
...
ALTER TABLE [enum_view] ADD CONSTRAINT [FK_enum_view_field] 
